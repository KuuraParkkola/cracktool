...
from CrackerCore.utilities.utility import flatten_nested_list
...
if __name__ == '__main__':
    ...
    group.add_argument('--sym', dest='pipeline_help', action='append_const', const='sym', help='add symbols: sym count s=$syms')
    group.add_argument('--subs', dest='pipeline_help', action='append_const', const='sym', help='make substitutions: subs count s=$syms o=$ord')
    group.add_argument('--numr', dest='pipeline_help', action='append_const', const='sym', help='add number range: numr range o=$ord')
    group.add_argument('--numd', dest='pipeline_help', action='append_const', const='sym', help='add digits: numd count o=$ord')
    group.add_argument('--caps', dest='pipeline_help', action='append_const', const='sym', help='capitalize characters: caps mode')
